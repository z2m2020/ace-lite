...
from ace_lite.orchestrator_runtime_support import run_orchestrator_finalization
...
def test_run_orchestrator_finalization_applies_contract_error_trace_and_runtime_hooks(
    ...
    orchestrator = SimpleNamespace(
        ...
        _export_stage_trace=lambda **kwargs: calls.append("trace") or {"enabled": True, "path": "trace.jsonl"},
        _record_durable_stats=lambda **kwargs: calls.append("durable") or durable_stats,
    )
