...
def aggregate_metrics(case_results: list[dict[str, Any]]) -> dict[str, float]:
    if not case_results:
        return {
            ...
            "utility_rate": 0.0,
            "noise_rate": 0.0,
            "docs_enabled_ratio": 0.0,
            "docs_hit_ratio": 0.0,
            "hint_inject_ratio": 0.0,
            "dependency_recall": 0.0,
            "memory_latency_p95_ms": 0.0,
            "index_latency_p95_ms": 0.0,
            "repomap_latency_p95_ms": 0.0,
            "augment_latency_p95_ms": 0.0,
            "skills_latency_p95_ms": 0.0,
            "skills_route_latency_p95_ms": 0.0,
            "skills_hydration_latency_p95_ms": 0.0,
            "source_plan_latency_p95_ms": 0.0,
            "latency_p95_ms": 0.0,
            "repomap_latency_median_ms": 0.0,
            ...
            "graph_prior_coverage_ratio": 0.0,
            "graph_prior_total_mean": 0.0,
            "graph_seeded_chunk_count_mean": 0.0,
            "graph_transfer_count_mean": 0.0,
            "graph_hub_suppressed_chunk_count_mean": 0.0,
            "graph_hub_penalty_total_mean": 0.0,
            ...
            "chunk_guard_fallback_ratio": 0.0,
            "skills_selected_count_mean": 0.0,
            "skills_token_budget_mean": 0.0,
            "skills_token_budget_used_mean": 0.0,
            ...
            "source_plan_packed_path_count_mean": 0.0,
            "evidence_insufficient_rate": 0.0,
            "no_candidate_rate": 0.0,
            "low_support_chunk_rate": 0.0,
            ...
            "parallel_docs_timeout_ratio": 0.0,
            "parallel_worktree_timeout_ratio": 0.0,
            "embedding_time_budget_exceeded_ratio": 0.0,
            "embedding_adaptive_budget_ratio": 0.0,
            "chunk_semantic_time_budget_exceeded_ratio": 0.0,
            "chunk_semantic_fallback_ratio": 0.0,
            "xref_budget_exhausted_ratio": 0.0,
            "slo_downgrade_case_rate": 0.0,
        }
...
def compare_metrics(
    *,
    ...
    return {
        "recall_at_k": float(current.get("recall_at_k", 0.0)) - float(baseline.get("recall_at_k", 0.0)),
        "hit_at_1": float(current.get("hit_at_1", 0.0)) - float(baseline.get("hit_at_1", 0.0)),
        "mrr": float(current.get("mrr", 0.0)) - float(baseline.get("mrr", 0.0)),
        "precision_at_k": float(current.get("precision_at_k", 0.0)) - float(baseline.get("precision_at_k", 0.0)),
        "task_success_rate": float(current.get("task_success_rate", current.get("utility_rate", 0.0)))
        - float(baseline.get("task_success_rate", baseline.get("utility_rate", 0.0))),
        "utility_rate": float(current.get("utility_rate", 0.0)) - float(baseline.get("utility_rate", 0.0)),
        "noise_rate": float(current.get("noise_rate", 0.0)) - float(baseline.get("noise_rate", 0.0)),
        "docs_enabled_ratio": float(current.get("docs_enabled_ratio", 0.0))
        - float(baseline.get("docs_enabled_ratio", 0.0)),
        "docs_hit_ratio": float(current.get("docs_hit_ratio", 0.0))
        - float(baseline.get("docs_hit_ratio", 0.0)),
        "hint_inject_ratio": float(current.get("hint_inject_ratio", 0.0))
        - float(baseline.get("hint_inject_ratio", 0.0)),
        "dependency_recall": float(current.get("dependency_recall", 0.0)) - float(baseline.get("dependency_recall", 0.0)),
        "memory_latency_p95_ms": float(current.get("memory_latency_p95_ms", 0.0))
        - float(baseline.get("memory_latency_p95_ms", 0.0)),
        "index_latency_p95_ms": float(current.get("index_latency_p95_ms", 0.0))
        - float(baseline.get("index_latency_p95_ms", 0.0)),
        "repomap_latency_p95_ms": float(current.get("repomap_latency_p95_ms", 0.0))
        - float(baseline.get("repomap_latency_p95_ms", 0.0)),
        "augment_latency_p95_ms": float(current.get("augment_latency_p95_ms", 0.0))
        - float(baseline.get("augment_latency_p95_ms", 0.0)),
        "skills_latency_p95_ms": float(current.get("skills_latency_p95_ms", 0.0))
        - float(baseline.get("skills_latency_p95_ms", 0.0)),
        "skills_route_latency_p95_ms": float(
            current.get("skills_route_latency_p95_ms", 0.0)
        )
        - float(baseline.get("skills_route_latency_p95_ms", 0.0)),
        "skills_hydration_latency_p95_ms": float(
            current.get("skills_hydration_latency_p95_ms", 0.0)
        )
        - float(baseline.get("skills_hydration_latency_p95_ms", 0.0)),
        "source_plan_latency_p95_ms": float(current.get("source_plan_latency_p95_ms", 0.0))
        - float(baseline.get("source_plan_latency_p95_ms", 0.0)),
        "repomap_latency_median_ms": float(current.get("repomap_latency_median_ms", 0.0))
        - float(baseline.get("repomap_latency_median_ms", 0.0)),
        "latency_p95_ms": float(current.get("latency_p95_ms", 0.0)) - float(baseline.get("latency_p95_ms", 0.0)),
        "latency_median_ms": float(current.get("latency_median_ms", 0.0)) - float(baseline.get("latency_median_ms", 0.0)),
        ...
        - float(baseline.get("robust_signature_count_mean", 0.0)),
        "robust_signature_coverage_ratio": float(
            current.get("robust_signature_coverage_ratio", 0.0)
        )
        - float(baseline.get("robust_signature_coverage_ratio", 0.0)),
        "graph_prior_chunk_count_mean": float(
            current.get("graph_prior_chunk_count_mean", 0.0)
        )
        - float(baseline.get("graph_prior_chunk_count_mean", 0.0)),
        "graph_prior_coverage_ratio": float(
            current.get("graph_prior_coverage_ratio", 0.0)
        )
        - float(baseline.get("graph_prior_coverage_ratio", 0.0)),
        "graph_prior_total_mean": float(current.get("graph_prior_total_mean", 0.0))
        - float(baseline.get("graph_prior_total_mean", 0.0)),
        "graph_seeded_chunk_count_mean": float(
            current.get("graph_seeded_chunk_count_mean", 0.0)
        )
        - float(baseline.get("graph_seeded_chunk_count_mean", 0.0)),
        "graph_transfer_count_mean": float(
            current.get("graph_transfer_count_mean", 0.0)
        )
        - float(baseline.get("graph_transfer_count_mean", 0.0)),
        "graph_hub_suppressed_chunk_count_mean": float(
            current.get("graph_hub_suppressed_chunk_count_mean", 0.0)
        )
        - float(baseline.get("graph_hub_suppressed_chunk_count_mean", 0.0)),
        "graph_hub_penalty_total_mean": float(
            current.get("graph_hub_penalty_total_mean", 0.0)
        )
        - float(baseline.get("graph_hub_penalty_total_mean", 0.0)),
        "graph_closure_enabled_ratio": float(
            current.get("graph_closure_enabled_ratio", 0.0)
        )
        - float(baseline.get("graph_closure_enabled_ratio", 0.0)),
        "graph_closure_boosted_chunk_count_mean": float(
            current.get("graph_closure_boosted_chunk_count_mean", 0.0)
        )
        - float(baseline.get("graph_closure_boosted_chunk_count_mean", 0.0)),
        "graph_closure_coverage_ratio": float(
            current.get("graph_closure_coverage_ratio", 0.0)
        )
        - float(baseline.get("graph_closure_coverage_ratio", 0.0)),
        "graph_closure_anchor_count_mean": float(
            current.get("graph_closure_anchor_count_mean", 0.0)
        )
        - float(baseline.get("graph_closure_anchor_count_mean", 0.0)),
        "graph_closure_support_edge_count_mean": float(
            current.get("graph_closure_support_edge_count_mean", 0.0)
        )
        - float(baseline.get("graph_closure_support_edge_count_mean", 0.0)),
        "graph_closure_total_mean": float(
            current.get("graph_closure_total_mean", 0.0)
        )
        - float(baseline.get("graph_closure_total_mean", 0.0)),
        "topological_shield_enabled_ratio": float(
            current.get("topological_shield_enabled_ratio", 0.0)
        )
        - float(baseline.get("topological_shield_enabled_ratio", 0.0)),
        "topological_shield_report_only_ratio": float(
            current.get("topological_shield_report_only_ratio", 0.0)
        )
        - float(baseline.get("topological_shield_report_only_ratio", 0.0)),
        "topological_shield_attenuated_chunk_count_mean": float(
            current.get("topological_shield_attenuated_chunk_count_mean", 0.0)
        )
        - float(
            baseline.get("topological_shield_attenuated_chunk_count_mean", 0.0)
        ),
        "topological_shield_coverage_ratio": float(
            current.get("topological_shield_coverage_ratio", 0.0)
        )
        - float(baseline.get("topological_shield_coverage_ratio", 0.0)),
        "topological_shield_attenuation_total_mean": float(
            current.get("topological_shield_attenuation_total_mean", 0.0)
        )
        - float(baseline.get("topological_shield_attenuation_total_mean", 0.0)),
        "chunk_guard_enabled_ratio": float(
            current.get("chunk_guard_enabled_ratio", 0.0)
        )
        - float(baseline.get("chunk_guard_enabled_ratio", 0.0)),
        "chunk_guard_report_only_ratio": float(
            current.get("chunk_guard_report_only_ratio", 0.0)
        )
        - float(baseline.get("chunk_guard_report_only_ratio", 0.0)),
        "chunk_guard_filtered_count_mean": float(
            current.get("chunk_guard_filtered_count_mean", 0.0)
        )
        - float(baseline.get("chunk_guard_filtered_count_mean", 0.0)),
        "chunk_guard_filter_ratio": float(
            current.get("chunk_guard_filter_ratio", 0.0)
        )
        - float(baseline.get("chunk_guard_filter_ratio", 0.0)),
        "chunk_guard_pairwise_conflict_count_mean": float(
            current.get("chunk_guard_pairwise_conflict_count_mean", 0.0)
        )
        - float(baseline.get("chunk_guard_pairwise_conflict_count_mean", 0.0)),
        "chunk_guard_fallback_ratio": float(
            current.get("chunk_guard_fallback_ratio", 0.0)
        )
        - float(baseline.get("chunk_guard_fallback_ratio", 0.0)),
        "skills_selected_count_mean": float(
            current.get("skills_selected_count_mean", 0.0)
        )
        - float(baseline.get("skills_selected_count_mean", 0.0)),
        "skills_token_budget_mean": float(
            current.get("skills_token_budget_mean", 0.0)
        )
        - float(baseline.get("skills_token_budget_mean", 0.0)),
        "skills_token_budget_used_mean": float(
            current.get("skills_token_budget_used_mean", 0.0)
        )
        - float(baseline.get("skills_token_budget_used_mean", 0.0)),
        "skills_budget_exhausted_ratio": float(
            current.get("skills_budget_exhausted_ratio", 0.0)
        )
        - float(baseline.get("skills_budget_exhausted_ratio", 0.0)),
        "skills_skipped_for_budget_mean": float(
            current.get("skills_skipped_for_budget_mean", 0.0)
        )
        - float(baseline.get("skills_skipped_for_budget_mean", 0.0)),
        "skills_metadata_only_routing_ratio": float(
            current.get("skills_metadata_only_routing_ratio", 0.0)
        )
        - float(baseline.get("skills_metadata_only_routing_ratio", 0.0)),
        "skills_precomputed_route_ratio": float(
            current.get("skills_precomputed_route_ratio", 0.0)
        )
        - float(baseline.get("skills_precomputed_route_ratio", 0.0)),
        "plan_replay_cache_enabled_ratio": float(
            current.get("plan_replay_cache_enabled_ratio", 0.0)
        )
        - float(baseline.get("plan_replay_cache_enabled_ratio", 0.0)),
        "plan_replay_cache_hit_ratio": float(
            current.get("plan_replay_cache_hit_ratio", 0.0)
        )
        - float(baseline.get("plan_replay_cache_hit_ratio", 0.0)),
        "plan_replay_cache_stale_hit_safe_ratio": float(
            current.get("plan_replay_cache_stale_hit_safe_ratio", 0.0)
        )
        - float(baseline.get("plan_replay_cache_stale_hit_safe_ratio", 0.0)),
        "validation_test_count": float(current.get("validation_test_count", 0.0)) - float(baseline.get("validation_test_count", 0.0)),
        "source_plan_graph_closure_preference_enabled_ratio": float(
            current.get("source_plan_graph_closure_preference_enabled_ratio", 0.0)
        )
        - float(
            baseline.get("source_plan_graph_closure_preference_enabled_ratio", 0.0)
        ),
        "source_plan_graph_closure_bonus_candidate_count_mean": float(
            current.get("source_plan_graph_closure_bonus_candidate_count_mean", 0.0)
        )
        - float(
            baseline.get(
                "source_plan_graph_closure_bonus_candidate_count_mean", 0.0
        ...
        "source_plan_graph_closure_preferred_count_mean": float(
            current.get("source_plan_graph_closure_preferred_count_mean", 0.0)
        )
        - float(
            baseline.get("source_plan_graph_closure_preferred_count_mean", 0.0)
        ),
        "source_plan_focused_file_promoted_count_mean": float(
            current.get("source_plan_focused_file_promoted_count_mean", 0.0)
        )
        - float(
            baseline.get("source_plan_focused_file_promoted_count_mean", 0.0)
        ),
        "source_plan_packed_path_count_mean": float(
            current.get("source_plan_packed_path_count_mean", 0.0)
        )
        - float(baseline.get("source_plan_packed_path_count_mean", 0.0)),
        "evidence_insufficient_rate": float(
            current.get("evidence_insufficient_rate", 0.0)
        )
        - float(baseline.get("evidence_insufficient_rate", 0.0)),
        "no_candidate_rate": float(current.get("no_candidate_rate", 0.0))
        - float(baseline.get("no_candidate_rate", 0.0)),
        "low_support_chunk_rate": float(
            current.get("low_support_chunk_rate", 0.0)
        )
        - float(baseline.get("low_support_chunk_rate", 0.0)),
        "missing_validation_rate": float(
            current.get("missing_validation_rate", 0.0)
        )
        - float(baseline.get("missing_validation_rate", 0.0)),
        "budget_limited_recovery_rate": float(
            current.get("budget_limited_recovery_rate", 0.0)
        )
        - float(baseline.get("budget_limited_recovery_rate", 0.0)),
        "noisy_hit_rate": float(current.get("noisy_hit_rate", 0.0))
        - float(baseline.get("noisy_hit_rate", 0.0)),
        "notes_hit_ratio": float(current.get("notes_hit_ratio", 0.0)) - float(baseline.get("notes_hit_ratio", 0.0)),
        "profile_selected_mean": float(current.get("profile_selected_mean", 0.0)) - float(baseline.get("profile_selected_mean", 0.0)),
        "capture_trigger_ratio": float(current.get("capture_trigger_ratio", 0.0)) - float(baseline.get("capture_trigger_ratio", 0.0)),
        "embedding_enabled_ratio": float(current.get("embedding_enabled_ratio", 0.0))
        - float(baseline.get("embedding_enabled_ratio", 0.0)),
        "embedding_similarity_mean": float(current.get("embedding_similarity_mean", 0.0))
        - float(baseline.get("embedding_similarity_mean", 0.0)),
        "embedding_similarity_max": float(current.get("embedding_similarity_max", 0.0))
        - float(baseline.get("embedding_similarity_max", 0.0)),
        "embedding_rerank_ratio": float(current.get("embedding_rerank_ratio", 0.0))
        - float(baseline.get("embedding_rerank_ratio", 0.0)),
        "embedding_cache_hit_ratio": float(
            current.get("embedding_cache_hit_ratio", 0.0)
        )
        - float(baseline.get("embedding_cache_hit_ratio", 0.0)),
        "embedding_fallback_ratio": float(
            current.get("embedding_fallback_ratio", 0.0)
        )
        - float(baseline.get("embedding_fallback_ratio", 0.0)),
        "parallel_time_budget_ms_mean": float(
            current.get("parallel_time_budget_ms_mean", 0.0)
        )
        - float(baseline.get("parallel_time_budget_ms_mean", 0.0)),
        "embedding_time_budget_ms_mean": float(
            current.get("embedding_time_budget_ms_mean", 0.0)
        )
        - float(baseline.get("embedding_time_budget_ms_mean", 0.0)),
        "chunk_semantic_time_budget_ms_mean": float(
            current.get("chunk_semantic_time_budget_ms_mean", 0.0)
        )
        - float(baseline.get("chunk_semantic_time_budget_ms_mean", 0.0)),
        "xref_time_budget_ms_mean": float(current.get("xref_time_budget_ms_mean", 0.0))
        - float(baseline.get("xref_time_budget_ms_mean", 0.0)),
        "parallel_docs_timeout_ratio": float(
            current.get("parallel_docs_timeout_ratio", 0.0)
        )
        - float(baseline.get("parallel_docs_timeout_ratio", 0.0)),
        "parallel_worktree_timeout_ratio": float(
            current.get("parallel_worktree_timeout_ratio", 0.0)
        )
        - float(baseline.get("parallel_worktree_timeout_ratio", 0.0)),
        "embedding_time_budget_exceeded_ratio": float(
            current.get("embedding_time_budget_exceeded_ratio", 0.0)
        )
        - float(baseline.get("embedding_time_budget_exceeded_ratio", 0.0)),
        "embedding_adaptive_budget_ratio": float(
            current.get("embedding_adaptive_budget_ratio", 0.0)
        )
        - float(baseline.get("embedding_adaptive_budget_ratio", 0.0)),
        "chunk_semantic_time_budget_exceeded_ratio": float(
            current.get("chunk_semantic_time_budget_exceeded_ratio", 0.0)
        )
        - float(baseline.get("chunk_semantic_time_budget_exceeded_ratio", 0.0)),
        "chunk_semantic_fallback_ratio": float(
            current.get("chunk_semantic_fallback_ratio", 0.0)
        )
        - float(baseline.get("chunk_semantic_fallback_ratio", 0.0)),
        "xref_budget_exhausted_ratio": float(
            current.get("xref_budget_exhausted_ratio", 0.0)
        )
        - float(baseline.get("xref_budget_exhausted_ratio", 0.0)),
        "slo_downgrade_case_rate": float(
            current.get("slo_downgrade_case_rate", 0.0)
        )
        - float(baseline.get("slo_downgrade_case_rate", 0.0)),
    }
